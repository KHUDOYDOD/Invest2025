        ...
        <main className="flex-1 p-6">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="text-center space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-gray-300 to-gray-400 bg-clip-text text-transparent">
                Вывод средств
              </h1>
              <p className="text-gray-300 max-w-2xl mx-auto">
                Выберите удобный способ получения и внимательно заполните заявку
              </p>
            </div>
                ...
                {currentStep === 3 && !isSuccess && (
                  <div className="space-y-6">
                    <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                      <h3 className="text-white font-medium mb-4">Проверьте данные заявки</h3>
                      ...
                      <div className="space-y-3">
                        ...
                        {selectedMethod === "card" && (
                          <>
                            ...
                            <div className="flex justify-between items-center">
                              <span className="text-white/70">ФИО владельца:</span>
                        ...
                        {selectedMethod === "sbp" && (
                          <>
                            ...
                            <div className="flex justify-between items-center">
                              <span className="text-white/70">ФИО владельца:</span>
                              <span className="text-white">{sbpName}</span>
                            </div>
                          </>
                        )}
                        ...
                        {selectedMethod === "crypto" && (
                          <>
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-white">
                                {cryptoNetwork === "trc20" ? "USDT TRC-20" : "USDT TON"}
                              </span>
                            </div>
                            <div className="flex justify-between items-center">
